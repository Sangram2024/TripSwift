...
export default function Head({ formData, formattedCardNumber }) {
  ...
  return (
    <header className="head--container relative flex flex-col max-md:items-center bg-[#21092F] h-60 w-full lg:w-[483px] lg:h-full">
      <div className="header--cards_image_container w-[343px] max-md:h-[200px]  mt-7 lg:ml-[164px] lg:mt-[120px] flex flex-col lg:flex-col-reverse lg:w-[541px] lg:h-[527px]">
        ...
        <div className="header--image_container_front w-[286px] lg:w-[447px] relative bottom-[68px] lg:bottom-[32px]">
          ...
          <div className=" circle--container  absolute top-[17.6px] left-[19px] lg:top-[28px] lg:left-[32px] flex items-center">
            <div className="header--circle_large bg-white w-[30px] h-[30px]  rounded-[15px] mr-[10px] lg:mr-4 lg:w-[47px] lg:h-[47px] lg:rounded-[23.5px]"></div>
